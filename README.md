# Scale — Study Dashboards

Interactive, self-contained study guides built from Geoffrey West's book
_Scale: The Universal Laws of Growth, Innovation, Sustainability, and the Pace
of Life in Organisms, Cities, Economies, and Companies_ (via the Moontower
reading notes).

Each file is a single HTML page with no external assets — open it in any
browser, online or offline. Both support light/dark themes.

| Dashboard | File | What it's for |
|---|---|---|
